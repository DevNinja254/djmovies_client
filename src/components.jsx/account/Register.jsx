    ...
    <div className='bg-white m-3 rounded-sm p-4'>
        ...
        <form onSubmit={handleSubmit} className='md:grid md:grid-cols-2'>
            <div className=' p-2 text-sm font-mono capitalize text-gray-600'>
                ...
                <input type="text"  className='textMidSm p-1 rounded-sm  border block w-full outline-none bg-white text-gray-600' disabled={isLoading} name='username'  value={formData.username} required={true} onChange={handleChange}/>
            </div>
            <div className=' p-2 text-sm font-mono capitalize text-gray-600'>
                <label className="block textMidSm text-gray-600 mt-2" htmlFor="email">Email</label>
                <input type="email" disabled={isLoading} className='textMidSm p-1 rounded-sm  border block w-full outline-none bg-white text-gray-600' name='email' required={true} value={formData.email} onChange={handleChange}/>
            </div>
            <div className=' p-2 text-sm font-mono capitalize text-gray-600'>
                ...
                <div className='bg-white w-full py-2 px-1 pr-2 rounded-sm  text-gray-600 flex justify-between items-center gap-3 border'>
                    <input type={`${showPwd ? "text": "password"}`} disabled={isLoading}  className='textMidSm p-1 rounded-sm   block w-full outline-none bg-white text-gray-600' name='password1' required={true}  value={formData.password1} onChange={handleChange} />
