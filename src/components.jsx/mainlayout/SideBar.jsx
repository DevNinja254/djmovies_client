...
const SideBar = ({setttingnav}) => {
  return (
    <div className={`h-full bgSlide slide  w-full col-span-2 sidebar`}>
      <div className='p-1 px-3 '>
      <NavLink className="flex items-center text-white text-opacity-90 text-md gap-2 hover:text-white px-3 py-2"  onClick={() => {
                    setttingnav(false)
                }} to='/'>
            <Home size={20}/>
            <p className='font-bold'>Home</p>
        </NavLink>
        <NavLink className="flex items-center text-white text-opacity-90 text-md gap-2 px-3 py-2 hover:text-white"  onClick={() => {
                    setttingnav(false)
                }} to='/store/series'>
            <Tv size={20}/>
        ...
        <NavLink  onClick={() => {
                    setttingnav(false)
                }} to='/genre'  className="flex items-center text-white text-opacity-90 text-md gap-2 px-3 py-2 hover:text-white">
            <Category size={20}/>
            <p className='font-bold'>Genre</p>
        </NavLink>
        <NavLink  onClick={() => {
                    setttingnav(false)
                }} to='/contact' className="flex items-center text-white text-opacity-90 text-md gap-2 px-3 py-2 hover:text-white">
            <Contact size={20}/>
            <p className='font-bold'>Contact</p>
        </NavLink>
        <NavLink  onClick={() => {
                    setttingnav(false)
                }} to='/about' className="flex items-center text-white text-opacity-90 text-md gap-2 px-3 py-2 hover:text-white">
            <About size={20}/>
